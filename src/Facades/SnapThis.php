 ...
 * @method static self view(string $view, $data = [], $mergeData = [])
 ...
 * @method static self deviceScale(int $scale)
 ...
 * @method static self margins(float $top, float $right, float $bottom, float $left, string $unit = 'in')
 ...
 * @method static self resizeTo(int $width, int $height, $method = 'contain')
